...
namespace CurrencyFetcherApi.IntegrationTests.Tests
{
    ...
    public class CurrencyPerformanceTests
    {
        ...
        [Test]
        public async Task WhenGetLargeAmountOfData_ThenCheckDiffrenceNoCacheAndCachedData()
        {
            ...
            try
            {
                ...
                var currencyResults = await _currencyAutomatedTestHelper.GetCurrencyResults();
                stopwatch.Stop();
                ...
                currencyResults = await _currencyAutomatedTestHelper.GetCurrencyResults();
                stopwatch.Stop();
